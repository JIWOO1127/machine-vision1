...
원본: https://github.com/JIWOO1127/machine-vision1/blob/feature/seojiwoo-detection/seojiwoo/core/locator.py
      (서지우님 작업물) — 로직은 원본과 동일, classroom_locator 패키지
      규약에 맞춰 이 파일만 옮겨졌다.
...
사용:
    from classroom_locator.landmark_locator import Locator
